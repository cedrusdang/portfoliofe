...
const dishes = [
  {
    ...
    price: "$10.99",
    img: "/imgs/Grilled-vegetables-with-cannellini-beans-vegan-pesto.jpg",
  ...
  },
  {
    ...
    price: "$13.99",
    img: "/imgs/Mediterranean grilled chicken salad.jpeg",
  ...
  },
  {
    ...
    price: "$14.50",
    img: "/imgs/mediterranean-chicken-square.avif",
  ...
  },
  {
    ...
    price: "$16.99",
    img: "/imgs/roasted cod or halibut with cherry tomatoes and green beans.jpeg",
  ...
  },
  {
    ...
    price: "$11.99",
    img: "/imgs/savory red lentil and vegetable stew served over mashed potatoes.jpg",
  ...
  },
  {
    ...
    price: "$17.99",
    img: "/imgs/sheet-pan-roasted-salmon-vegetables.jpg",
        ...
        <div className="menu-grid">
          {dishes.map((dish, idx) => (
            <div className="card" key={idx}>
			  ...
			  >
                Order a delivery{" "}
                <img src="/imgs/motobike.png" alt="Delivery" loading="lazy" />
              </button>
            </div>
          ))}
        </div>
