      ...
      <div className="App-banner-block">
        <div className='Banner-Background'>
          <div className='Banner'>
            ...
            <img src='/imgs/restaurant.jpg' className='Banner-image' alt="Mario and Adrian"/>
          </div>
        </div>
      </div>
      <div className="App-content-block">
        <div className="special">
          ...
          <div className="content">
            <div className="card">
              <img src="./imgs/Mario and Adrian A.jpg" alt="Founders Mario and Adrian" className="card-image"/>
            ...
            <div className="card">
              <img src="./imgs/restaurant chef B.jpg" alt="Kitchen team at work" className="card-image"/>
              <div className="card-header">
            ...
            <div className="card">
              <img src="./imgs/Mario and Adrian b.jpg" alt="Chef preparing meals" className="card-image"/>
              <div className="card-header">
